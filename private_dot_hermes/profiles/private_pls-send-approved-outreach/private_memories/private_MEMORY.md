...
§
Transformity: worktrees beside main; pd-=PagerDuty. FE repro mise node22; BE Java17 bootRun. Kurama verify: run Kurama+FE proxy, sign into POS with local gamma creds, then check change. POS prod DB RO: production profile, IAM jay_hermes, DB postgres, AWS SSL bundle, BEGIN READ ONLY; helper connect_to_rds_iam. Never print UI creds.
§
